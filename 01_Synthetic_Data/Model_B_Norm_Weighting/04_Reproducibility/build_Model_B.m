...
origin = [-10000.00 -20400.00     -2000.00];
% origin = [0 0 0];
iterfile1 = 'Model_G_new_jieti_inv0.ws';
iterfile2 = 'Model_M_new_jieti_inv0.ws';
Modelcase = 'MG';%'MG','EM'
...
% Mag
B1 = 5; B2 = 5; B3 = 10; Background2 = 0.0;
rho1(:,:,:) = Background1;
rho2(:,:,:) = Background2;

% % 断层
 for i =1:7
   rho1(2+i:5+i,9:12,i+8)   = A1;  %阶梯1  
   rho2(2+i:5+i,9:12,i+8)   = B1;  %阶梯1
   rho1(26-i:29-i,9:12,i+9) = A2;  %阶梯2
   rho2(26-i:29-i,9:12,i+9) = B2;  %阶梯2
 end

% 盖层
rho1(12:20,7:14,9:12)=A3;
rho2(12:20,7:14,9:12)=B3;
